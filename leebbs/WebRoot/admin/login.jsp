...
<%@page import="com.leebbs.core.utils.Setting"%>
<%@page import="com.leebbs.core.utils.SettingUtils"%>
<%@page import="com.leebbs.core.utils.SpringUtils"%>
<%@page import="org.apache.shiro.web.filter.authc.FormAuthenticationFilter"%>
<%@page import="java.util.UUID"%>
<%@page import="com.leebbs.core.utils.Setting.AccountLockType"%>
<%@page import="org.apache.commons.lang.ArrayUtils"%>
<%@page import="com.leebbs.core.utils.Setting.CaptchaType"%>
	...
	<%if (applicationContext != null) {%>
	    ...
	    <form class="form-signin form-horizontal" id="loginForm" action="login.jsp" method="post">
	        ...
	        <div class="form-signin-heading text-center">
	            <h1 class="sign-title"><i class="fa fa-sun-o"></i>学享科技-"留学后"</h1>
