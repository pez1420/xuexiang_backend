        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li>角色列表(共<span id="pageTotal">${page.total}</span>条记录)</li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="clearfix">
                        <label>
                            ...
                            <input class="form-control input-sm search_para" name="name" type="text"  placeholder="名称"
                            ...
                            <table class="table table-striped table-hover table-bordered" id="listTable">
                                ...
                                [#list page.content as role]
	                                <tr>
	                                    ...
	                                    <td>${role.createDate?string("yyyy-MM-dd")}</td>
	                                    <td>
	                                        <a href="edit.jhtml?id=${role.id}" class="btn btn-info"><i class="fa fa-pencil-square"></i>编辑
	                                        </a>
	                                    </td>
	                                </tr>
                                [/#list]
