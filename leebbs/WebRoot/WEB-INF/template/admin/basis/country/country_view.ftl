        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li>国家列表(共<span id="pageTotal">${page.total}</span>条记录)</li>
                </ul>
            </div>
        </div>
        <form id="listForm" action="list.jhtml" method="get">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="clearfix">
                        <label>
                            <span style="margin-right: 15px;">国家名</span>
                            <input type="text" class="form-control input-sm" placeholder="国家名" name="name"
                                   value="${search.name}" style="width: 150px; display: inline-block; margin-right: 30px;">
                        </label>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <a href="country_add.html" class="btn btn-xs btn-info"><i class="fa fa-plus-circle"></i> 添加</a>
                        </div>
                        <div class="panel-body">
                            <table class="table table-striped table-hover table-bordered" id="listTable">
                                ...
                                <tr>
                                    <td><input type="checkbox" name="ids" value="${country.id}"></td>
                                    <td>${country.name}</td>
                                    <td>
                                        <a href="country_edit.html" class="btn btn-info"><i class="fa fa-pencil-square"></i>编辑
                                        </a>
                                    </td>
                                </tr>
                                [/#list]
